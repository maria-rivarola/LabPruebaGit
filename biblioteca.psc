...
Funcion crearSocio(socios Por Referencia, cantSocios)
	...
	Mientras !confirma Hacer
		...
		Sino	
			...
			espacio
			Escribir Sin Saltar "DNI del socio: ", dniSocio
			Escribir Sin Saltar "Nombre y Apellido: ", nombreSocio
			Escribir sin saltar "Teléfono: ", telSocio
			Escribir sin saltar "Condición: ", condSocio	
			Escribir Sin Saltar "Contraseña: ", pwdSocio
			espacio
			opUsuario <- confirmarInformacion("Confirma ingreso? (S/N)")
			Esperar 1 segundo
...
SubProceso despedidaSistema
	...
	Escribir "          $$  __$$\                              \__|                                                                                                             "
	Escribir "          $$ /  \__| $$$$$$\  $$$$$$\   $$$$$$$\ $$\  $$$$$$\   $$$$$$$\        $$$$$$\   $$$$$$\   $$$$$$\        $$\   $$\  $$$$$$$\  $$$$$$\   $$$$$$\        "
	Escribir "          $$ |$$$$\ $$  __$$\ \____$$\ $$  _____|$$ | \____$$\ $$  _____|      $$  __$$\ $$  __$$\ $$  __$$\       $$ |  $$ |$$  _____| \____$$\ $$  __$$\       "
	Escribir "          $$ |\_$$ |$$ |  \__|$$$$$$$ |$$ /      $$ | $$$$$$$ |\$$$$$$\        $$ /  $$ |$$ /  $$ |$$ |  \__|      $$ |  $$ |\$$$$$$\   $$$$$$$ |$$ |  \__|      "
	Escribir "          $$ |  $$ |$$ |     $$  __$$ |$$ |      $$ |$$  __$$ | \____$$\       $$ |  $$ |$$ |  $$ |$$ |            $$ |  $$ | \____$$\ $$  __$$ |$$ |            "
	Escribir "          \$$$$$$  |$$ |     \$$$$$$$ |\$$$$$$$\ $$ |\$$$$$$$ |$$$$$$$  |      $$$$$$$  |\$$$$$$  |$$ |            \$$$$$$  |$$$$$$$  |\$$$$$$$ |$$ |            "
	Escribir "           \______/ \__|      \_______| \_______|\__| \_______|\_______/       $$  ____/  \______/ \__|             \______/ \_______/  \_______|\__|            "
	Escribir "                                                                           $$ |                                                                              "
	Escribir "                                                                           $$ |                                                                              "
	Escribir "                                                                           \__|                                                                              "
	Escribir " $$$$$$\  $$\             $$\                                                   $$\                  $$$$$$\                        $$\     $$\                     "
	...
	Escribir "$$ /  \__|$$\  $$$$$$$\ $$$$$$\    $$$$$$\  $$$$$$\$$$$\   $$$$$$\         $$$$$$$ | $$$$$$\        $$ /  \__| $$$$$$\   $$$$$$$\ $$$$$$\   $$\  $$$$$$\  $$$$$$$\  "
	Escribir "\$$$$$$\  $$ |$$  _____|\_$$  _|  $$  __$$\ $$  _$$  _$$\  \____$$\       $$  __$$ |$$  __$$\       $$ |$$$$\ $$  __$$\ $$  _____|\_$$  _|  $$ |$$  __$$\ $$  __$$\ "
	Escribir " \____$$\ $$ |\$$$$$$\    $$ |    $$$$$$$$ |$$ / $$ / $$ | $$$$$$$ |      $$ /  $$ |$$$$$$$$ |      $$ |\_$$ |$$$$$$$$ |\$$$$$$\    $$ |    $$ |$$ /  $$ |$$ |  $$ |"
	Escribir "$$\   $$ |$$ | \____$$\   $$ |$$\ $$   ____|$$ | $$ | $$ |$$  __$$ |      $$ |  $$ |$$   ____|      $$ |  $$ |$$   ____| \____$$\   $$ |$$\ $$ |$$ |  $$ |$$ |  $$ |"
	Escribir "\$$$$$$  |$$ |$$$$$$$  |  \$$$$  |\$$$$$$$\ $$ | $$ | $$ |\$$$$$$$ |      \$$$$$$$ |\$$$$$$$\       \$$$$$$  |\$$$$$$$\ $$$$$$$  |  \$$$$  |$$ |\$$$$$$  |$$ |  $$ |"
	Escribir " \______/ \__|\_______/    \____/  \_______|\__| \__| \__| \_______|       \_______| \_______|       \______/  \_______|\_______/    \____/ \__| \______/ \__|  \__|"
	Escribir "                                                                                                                                            "
	Escribir "                                                                                                                                            "
	Escribir "                        $$\                 $$$$$$$\  $$\ $$\       $$\ $$\            $$\                                   	$$\ "
	Escribir "                         $$ |                $$  __$$\ \__|$$ |      $$ |\__|           $$ |                                 	$$ |"
	Escribir "                    $$$$$$$ | $$$$$$\        $$ |  $$ |$$\ $$$$$$$\  $$ |$$\  $$$$$$\ $$$$$$\    $$$$$$\   $$$$$$$\ $$$$$$\  	$$ |"
	Escribir "                   $$  __$$ |$$  __$$\       $$$$$$$\ |$$ |$$  __$$\ $$ |$$ |$$  __$$\\_$$  _|  $$  __$$\ $$  _____|\____$$\ 	$$ |"
	Escribir "                   $$ /  $$ |$$$$$$$$ |      $$  __$$\ $$ |$$ |  $$ |$$ |$$ |$$ /  $$ | $$ |    $$$$$$$$ |$$ /      $$$$$$$ |	\__|"
	Escribir "                   $$ |  $$ |$$   ____|      $$ |  $$ |$$ |$$ |  $$ |$$ |$$ |$$ |  $$ | $$ |$$\ $$   ____|$$ |     $$  __$$ |"
	Escribir "                   \$$$$$$$ |\$$$$$$$\       $$$$$$$  |$$ |$$$$$$$  |$$ |$$ |\$$$$$$  | \$$$$  |\$$$$$$$\ \$$$$$$$\\$$$$$$$ |	$$\"
	Escribir "                    \_______| \_______|      \_______/ \__|\_______/ \__|\__| \______/   \____/  \_______| \_______|\_______|	\__|"
	Escribir "                                                                                                          "
FinSubProceso
